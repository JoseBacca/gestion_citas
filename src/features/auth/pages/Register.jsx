...
import { Loader2, User, Mail, CreditCard, Lock, Calendar, Shield, Users, Heart } from "lucide-react";

export default function Register() {
    const [formData, setFormData] = useState({ email: "", password: "", confirmPassword: "", full_name: "", document_number: "", role_id: "APRENDIZ" });
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        const result = await signUp(formData.email, formData.password, { full_name: formData.full_name, document_number: formData.document_number, role_id: formData.role_id });
        setLoading(false);
